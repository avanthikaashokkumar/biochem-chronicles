...
- Added real article pages for every article card.
- Added `articles.html` with search and category filters.
- Rewrote project content in a clearer student voice.
...
- Removed all em dash characters from source files.

## v1.0.0

- Initial static portfolio homepage.
- Added project cards, skills section, contact links, and placeholder explainers.
